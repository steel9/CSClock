...
namespace PCTime
{
    public partial class SelectLanguage : Form
    {
        ...
        private void Button_Click(object sender, EventArgs e)
        {
            ...
            {
                if (MessageBox.Show(string.Format(Program.rm_Messages.GetString("changeLang_confirm_msg"), ((Button)sender).Text), "PCTime", MessageBoxButtons.OKCancel,
        ...
        private void SelectLanguage_Load(object sender, EventArgs e)
        {
            ...
            Program.rm_SelectLanguage = new ResourceManager(string.Format("PCTime.Languages.{0}.SelectLanguage", Program.selectedLanguage), Program.assembly);
