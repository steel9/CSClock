...
namespace CSClock
{
    partial class About : Form
    {
        public About()
        {
            ...
            Program.rm_About = new ResourceManager(string.Format("CSClock.Languages.{0}.About", Program.selectedLanguage), Program.assembly);

            if (Program.rm_AssemblyInfo == null)
            {
                Program.rm_AssemblyInfo = new ResourceManager(string.Format("CSClock.Languages.{0}.AssemblyInfo", Program.selectedLanguage),
                    Program.assembly);
            }
        ...
        private void About_Load(object sender, EventArgs e)
        {
            ...
            button_feedbackDonate.Text = Program.rm_About.GetString("button_feedbackDonate");
        }
        ...
        private void saveFileDialog1_FileOk(object sender, System.ComponentModel.CancelEventArgs e)
        {
            ...
            MessageBox.Show("Log exported to: " + saveFileDialog1.FileName, "CSClock", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
