...
namespace CSClock
{
    public partial class SetOvertime : Form
    {
        ...
        {
            Program.CSClockForm.maximumSecondsOvertime = (int)(numericUpDown_maximumMinutesOvertime.Value * 60);
        ...
        {
            Program.rm_SetOvertime = new ResourceManager(string.Format("CSClock.Languages.{0}.SetOvertime", Program.selectedLanguage), Program.assembly);
